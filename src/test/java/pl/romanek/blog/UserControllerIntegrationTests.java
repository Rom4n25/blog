...
public class UserControllerIntegrationTests {
    ...
    public void shouldGetAllUsers() throws Exception {
        ...
        String userAsJson = objectMapper.writeValueAsString(UserResponseMapper.INSTANCE.toUsersResponseDto(users));
        mockMvc.perform(MockMvcRequestBuilders
                .get("/users/all")).andDo(MockMvcResultHandlers.print())
                .andExpect(MockMvcResultMatchers.status().isOk())
                .andExpect(MockMvcResultMatchers.content().string(userAsJson));
    }
    ...
    public void shouldGetUser() throws Exception {
        ...
        String userAsJson = objectMapper.writeValueAsString(UserResponseMapper.INSTANCE.toUserResponseDto(user));
        mockMvc.perform(MockMvcRequestBuilders
                .get("/users/1")).andDo(MockMvcResultHandlers.print())
                .andExpect(MockMvcResultMatchers.status().isOk())
                .andExpect(MockMvcResultMatchers.content().string(userAsJson));
    }
